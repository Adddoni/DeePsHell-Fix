...
start "DeePsHell: %~n0" /min "%BIN%DeePsHell.exe" --wf-tcp=80,443,2053,2083,2087,2096,8443,1-65000,%GameFilter% --wf-udp=80,443,500-1400,3478-3481,5222-5243,19294-19344,9000-56110,%GameFilter% ^
