...
start "DeePsHell: %~n0" /min "%BIN%DeePsHell.exe" --daemon --wf-tcp=1-65000,%GameFilter% --dpi-desync=multisplit --dpi-desync-split-pos=2,sniext+1 --dpi-desync-split-seqovl=679 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --wf-udp=80,443,500-1400,3724,3478-4380,5060-5062,5222-5243,6112-6119,6250,7000-8000,8088,8180-8181,9000-65535,%GameFilter% --dpi-desync=multisplit --dpi-desync-split-pos=2,sniext+1 --dpi-desync-split-seqovl=679 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" ^
...
--filter-tcp=80,443,8080 --hostlist="%LISTS%List-BazInt-PsHell.txt" --dpi-desync=multisplit --dpi-desync-split-pos=2,sniext+1 --dpi-desync-split-seqovl=679 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --new ^
...
--filter-udp=80,443,1119-1120,1024-1124,3724,3478-4380,5060-5062,6112-6119,6250,7000-8000,8088,8180-8181,12000-65535,%GameFilter% --hostlist="%LISTS%List-Game-PsHell.txt" --dpi-desync=multisplit --dpi-desync-repeats=6 --dpi-desync-fake-quic="%BIN%quic_initial_www_google_com.bin" --new ^
...
--filter-tcp=80,443,1935,%GameFilter% --hostlist="%LISTS%List-See-PsHell.txt" --dpi-desync=multisplit --dpi-desync-split-pos=2,sniext+1 --dpi-desync-split-seqovl=679 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --new ^
...
--filter-udp=80,443,1119-1120,1024-1124,3724,3478-4380,5060-5062,6112-6119,6250,7000-8000,8088,8180-8181,12000-65535,%GameFilter% --ipset="%IPSET%Ip-Set-Game.txt" --dpi-desync=multisplit --dpi-desync-repeats=6 --dpi-desync-fake-quic="%BIN%quic_initial_www_google_com.bin" --new ^
--filter-tcp=80,443,1024-1124,2099,3724,3074-3479,4000,5060-5062,5222-5223,6112-6120,6250,8088,8393-8400,9960-9969,12000-65000,%GameFilter% --ipset="%IPSET%Ip-Set-Game.txt" --dpi-desync=multisplit --dpi-desync-split-pos=2,sniext+1 --dpi-desync-split-seqovl=679 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --new ^
...
--filter-udp=80,443,8080 --ipset="%IPSET%Ip-Set-BazInt.txt" --dpi-desync=multisplit --dpi-desync-repeats=6 --dpi-desync-fake-quic="%BIN%quic_initial_www_google_com.bin" --new ^
