...
--filter-tcp=80,443,%GameFilter% --hostlist="%LISTS%List-Google-Mete-PsHell.txt" --dpi-desync=multisplit --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --new ^
...
--filter-tcp=80,443,%GameFilter% --hostlist="%LISTS%List-Snapchat-PsHell.txt" --dpi-desync=multisplit --dpi-desync=multisplit --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --new ^
...
--filter-tcp=80,443,5223,%GameFilter% --hostlist="%LISTS%List-FaceTime-PsHell.txt" --dpi-desync=multisplit --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --new ^
...
--filter-tcp=443,80,%GameFilter% --hostlist="%LISTS%List-Signal-PsHell.txt" --dpi-desync=multisplit --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --new ^
...
--filter-tcp=80,4244,5222-5228,5242,%GameFilter% --hostlist="%LISTS%List-WhatsApp-PsHell.txt" --dpi-desync=multisplit --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --new ^
...
--filter-udp=443,%GameFilter% --hostlist="%LISTS%List-Discord-PsHell.txt" --filter-l7=stun --dpi-desync=udplen --dpi-desync-repeats=6 --dpi-desync-udplen-increment=31 --new ^
...
--filter-tcp=80,443,4244,5242,%GameFilter% --hostlist="%LISTS%List-Viber-PsHell.txt" --dpi-desync=multisplit --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --new ^
...
--filter-tcp=1-65000,%GameFilter% --ipset="%IPSET%Ip-Set-Telegram.txt" --dpi-desync=multisplit --dpi-desync=multisplit --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --new ^
